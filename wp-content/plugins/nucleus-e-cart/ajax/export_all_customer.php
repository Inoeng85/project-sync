...
$request_for_customer = new StdClass();
$request_for_customer->requestMethod = "export_all_customer_from_ecart";
$request_for_customer->company_name = "$company_name";
$request_for_customer->company_url = "$company_url";
$request_for_customer->nucleus_api_username = "$nucleus_api_username";
$request_for_customer->nucleus_api_password = "$nucleus_api_password";
$request_for_customer->nucleus_api_key = "$nucleus_api_key";

$qry = mysql_query("select * from wp_ecart_customer a, wp_ecart_customer_address b where b.customer_id=a.customer_id");
while($data = mysql_fetch_array($qry))
{
	...
	$request_for_customer->Customers[] = $request_customer;
}
...
$xml_data = Parser::Obj2XML($request_for_customer);
